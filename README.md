...
主畫面儀表板提供可點擊 KPI 卡片（庫存不足、應收／應付餘額、出貨／進貨、待核准單據等）、
近 12 月營收趨勢、應收帳齡分佈與庫存不足警示。
...
- 極簡高級灰（2026 現代）：深炭側邊導覽、極淺灰表面、單一深藍強調、表格列頭淺灰底深字。
- 全系統色彩、圓角、間距由 `UiTheme` 單一來源定義；按鈕（`ModernButton`）採深藍漸層，
  卡片柔和陰影與懸停反饋，所有表單與對話框一致套用。
